...
QToolButton* createButtonWithStates(const QString& spriteSheetPath) {
    ...
    QIcon buttonIcon;
    buttonIcon.addPixmap(spriteSheet.copy(0 * spriteSize, 0, spriteSize, spriteSize), QIcon::Normal);
    buttonIcon.addPixmap(spriteSheet.copy(1 * spriteSize, 0, spriteSize, spriteSize), QIcon::Active);
    buttonIcon.addPixmap(spriteSheet.copy(2 * spriteSize, 0, spriteSize, spriteSize), QIcon::Selected);
    buttonIcon.addPixmap(spriteSheet.copy(3 * spriteSize, 0, spriteSize, spriteSize), QIcon::Disabled);
...
CloseBar::CloseBar(QWidget *parent) : QToolBar(parent)
{
    ...
    QToolButton* yellowButton = createButtonWithStates("./assets/yellow_buttons.png");
    QToolButton* greenButton = createButtonWithStates("./assets/green_buttons.png");
